...
<body>
	...
	<%
		...
		String mfname=request.getParameter("manufacturer");
		String mdate=request.getParameter("dat");
		...
		String query2="insert into product(prid,prname,manufacturer,dat,addesss,contact) values (?,?,?,?,?,?)";
		...
		try{
			...
			conn=DriverManager.getConnection("jdbc:mysql://localhost:3306/resourcedatabase","root","root");
