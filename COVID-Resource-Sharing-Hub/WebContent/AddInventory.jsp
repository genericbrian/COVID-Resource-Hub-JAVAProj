 				...
 				<div class="column">
    				<div class="card">
    					<form action="UpdateInventory.jsp" method="post">
    						<img src="images/inventory.png" width=180 height=200>
  							<h1><%=rs.getString("pname") %></h1>
  							<p><b>ID: </b><%=rs.getString("pid") %></p>
							<p><b>Provider: </b><%=rs.getString("manufacturer") %></p>
							<p><b>Date Posted: </b><%=rs.getDate("dat") %></p>
							<p><b>Address: </b><%=rs.getString("address") %></p>
							<p><b>Quantity: </b><%=rs.getInt("quantity") %></p>
							<p><b>Contact No : </b><%=rs.getInt("contact") %></p>
